...
filterUnfundedOnly(); // call the function to show unfunded games
...
function filterFundedOnly() {
    ...
    fundedGames = GAMES_JSON.filter((game) => {
        return game.pledged >= game.goal;
    });
...
showAllGames(); // call the function to show all games
...
const unfundedGamesString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games.
Currently, ${unfundedGamesCount === 1 ? " game remains unfunded." : ` ${unfundedGamesCount} games remain unfunded.`}
